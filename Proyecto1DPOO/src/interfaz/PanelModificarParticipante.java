...
public class PanelModificarParticipante extends JPanel implements ActionListener
{
	...
	public PanelModificarParticipante(VentanaPrincipal Pprincipal, Proyecto Pproyecto)
	{
		...
		txtEncabezado = new JLabel("<html><div style='text-align: center;'>Ingrese los datos del participante que desea modificar:</div><html>");
